...
if __name__ == '__main__':
    ...
    # -------------Parameters-------------
    n_tasks = 6
    learningrate =0.00039978519539599284
    epochs = 8000
    ...
    model_path = model_ + 'mmoe_' + feature_ + '_MOF_6task_MOF_ALL.pth'
    ...
    for i in range(n_tasks):
        Net.towers[i].add_module("add_fc1", nn.Linear(1, 4))
        Net.towers[i].add_module("add_fc1_relu", nn.ReLU())
        Net.towers[i].add_module("add_fc2", nn.Linear(4, 1))
        Net.towers[i].add_module("add_fc2_relu", nn.ReLU())
    ...
    model_out = model_ + 'TL_mmoe_' + feature_ + '_6stak2.pth'
